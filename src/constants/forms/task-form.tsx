...
interface Props {
	// title va isEdit ishlatilmasa, ularsiz qoldirish mumkin yoki ishlatiladigan qilib yozish kerak
	title?: string
	isEdid?: boolean
	onClosed?: () => void
	handler: (values: z.infer<typeof formSchema>) => Promise<void>
}

const TaskForm = ({ title = '', isEdid, onClosed, handler }: Props) => {
